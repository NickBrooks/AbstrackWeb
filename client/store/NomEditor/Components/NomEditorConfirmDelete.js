...
class NomEditorConfirmDelete extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div className="text-center">
                <p className="lead"><FontAwesome name="exclamation-triangle" size="lg" className="nom-orange-light" /> You're saying goodbye to a potential masterpiece...</p>
...
export default NomEditorConfirmDelete;