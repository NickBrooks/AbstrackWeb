export const logo = {
    blue: require('!!file-loader!../images/logo/AbstrackLogo.svg'),
    white: require('!!file-loader!../images/logo/AbstrackLogoWhite.svg')
}

export const icons = {
    note: require('!!file-loader!../images/icons/note.svg'),
